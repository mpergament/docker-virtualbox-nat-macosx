...
b978737f64c7        juniper/open-nti    "/sbin/my_init"     16 seconds ago      Up 14 seconds       0.0.0.0:80->80/tcp, 0.0.0.0:3000->3000/tcp, 0.0.0.0:8083->8083/tcp, 0.0.0.0:6000->6000/udp, 0.0.0.0:8125->8125/udp, 8125/tcp, 0.0.0.0:50000->50000/udp, 50000/tcp, 50010/tcp, 0.0.0.0:50010->50010/udp, 0.0.0.0:50020->50020/udp, 50020/tcp, 0.0.0.0:8086->8086/tcp   open-nti_con  
```
```
...
```
```
bash-3.2$ python docker-install-pat-macosx.py -c open-nti_con -a add  
...
```
```
bash-3.2$ python docker-install-pat-macosx.py -c open-nti_con -a delete  
URL: https://192.168.99.100:2376  
```
```
bash-3.2$ VBoxManage showvminfo "default" | grep Rule  
